...
import com.arimukti.anbuapp.databinding.MovieLoadStateBinding

class GenreLoadStateAdapter(private val retry: () -> Unit) : LoadStateAdapter<GenreLoadStateAdapter.LoadStateViewHolder>() {
